...
Line 67:7 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 73:25 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
...
class CartDrawer extends HTMLElement {
  ...
  open(triggeredBy) {
    ...
    var swiper = new Swiper(".CFP_outer .swiper-container", {
        slidesPerView: "auto",
        spaceBetween: 0,
       observer: true,
      observeParents: true,
      navigation: {
        nextEl: '.CFP_outer .swiper-button-next',
        prevEl: '.CFP_outer .swiper-button-prev',
      },
     });
  }
